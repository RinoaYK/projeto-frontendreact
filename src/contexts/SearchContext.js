...
const SearchProvider = ({ children }) => {
  ...
  const [marcaFilter, setMarcaFilter] = useState(localStorage.getItem('marcaFilter') || '');
...
return (
    <SearchContext.Provider value={{ typeFilter, setTypeFilter, filterByType, filterByMarca, setMarcaFilter, nameSearch, setNameSearch, nameSearchIncludes, minPrice, setMinPrice, maxPrice, setMaxPrice, filterByPrice, order, setOrder, sortItens, resetFilters, resetFilterType, resetName }}>
      {children}
